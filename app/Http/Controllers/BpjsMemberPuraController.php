...
class BpjsMemberPuraController extends Controller
{
    ...
    public function create($id)
    {
        ...
        return view('bpjs.pura.create',compact('citizen','nama'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bpjs.pura.index')->with('success', 'Data Bpjs Berhasil Ditambahkan');

    }
    public function edit($id)
    {
        $bpjs_member = BpjsMember::findOrfail($id);
        return view('bpjs.pura.edit', compact('bpjs_member'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('bpjs.pura.index')->with('success', 'Data Bpjs Berhasil Diperbaharui');
    }
    public function destroy($id)
    {
      ...
      return redirect()->route('bpjs.pura.index')->with('success', 'Data Bpjs Berhasil Dihapus');
    }
