...
class CitizenLebihController extends Controller
{
    //
    public function index($id)
    {
        $citizen = Citizen::where('wilayah_id', $id)->get();
        return view('citizen.lebih.index',compact('citizen'));
    }
    ...
    public function create($id)
    {
       ...
       $assistancetypes = AssistanceTypes::all();
        ...
        return view('citizen.lebih.create',compact('village','religion','profesion','maritalstatus','familyhead','educationlevel','assistancetypes'));
    }
    ...
    \App\Models\Citizen::create([
        ...
        return redirect()->route('lebih.show',$request->kepala_keluarga)->with('success','Data ( '. $request->nama_lengkap . ' ) Berhasil Di Tambahkan');
    }
    ...
    public function edit( $id)
    {
        ...
        $maritalstatus = MaritalStatus::all();
        $assistancetypes = AssistanceTypes::all();
        return view('citizen.lebih.edit',compact('citizen','religion','profesion','educationlevel','maritalstatus','assistancetypes'));
    }
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('lebih.show',$request->kepala_keluarga)->with('success','Data ( '. $request->nama_lengkap . ' ) Berhasil Di Perbaharui');
    ...
    public function Show($id)
    {
        ...
        return view('citizen.lebih.show',compact('citizen','age','tanggal_lahir'));
    }
    ...
    public function destroy($id)
    {
        ...
        $citizen->delete();
        return redirect()->route('lebih.show',$family_id)->with('success','Data ( ' . $nama .  ' ) Berhasil Di Hapus');
