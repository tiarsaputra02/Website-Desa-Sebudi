...
class FamilyHeadLebihController extends Controller
{
    //
    public function index()
    {
        $family = FamilyHead::with('village')
            ...
            ->where('wilayah_id',9)
            ->get();
        return view('family.lebih.index', compact('family'));
    }

   public function create()
    {
       $village = Village::all();
       return view('family.lebih.create',compact('village'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('lebih.index')->with('success','Data Kepala_Keluarga Baru Berhasil Di Tambahkan');
    }
    ...
    return view('family.lebih.edit', compact('family'));
    }
    ...
    // Simpan perubahan
    $family->save();
    return redirect()->route('lebih.index')->with('success', 'Data kepala keluarga berhasil Di Perbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        $family->delete();
        return redirect()->route('lebih.index')->with('success', 'Data kepala keluarga berhasil Di Hapus.');
    ...
    public function show($id)
    {
        ...
        return view('family.lebih.show',compact('family','jenis_surat'));
