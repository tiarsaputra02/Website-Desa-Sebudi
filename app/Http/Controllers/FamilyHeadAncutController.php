...
class FamilyHeadAncutController extends Controller
{
    public function index()
    {
        $family = FamilyHead::with('village')
            ...
            ->where('wilayah_id',6)
            ->get();
        return view('family.ancut.index', compact('family'));
    }

   public function create()
    {
       $village = Village::all();
       return view('family.ancut.create',compact('village'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ancut.index')->with('success','Data Kepala_Keluarga Baru Berhasil Di Tambahkan');
    }
    ...
    return view('family.ancut.edit', compact('family'));
    }
    ...
    // Simpan perubahan
    $family->save();
    return redirect()->route('ancut.index')->with('success', 'Data kepala keluarga berhasil Di Perbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        $family->delete();
        return redirect()->route('ancut.index')->with('success', 'Data kepala keluarga berhasil Di Hapus.');
    ...
    public function show($id)
    {
        ...
        return view('family.ancut.show',compact('family','jenis_surat'));
