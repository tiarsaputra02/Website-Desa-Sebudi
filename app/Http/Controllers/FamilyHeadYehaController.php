...
class FamilyHeadYehaController extends Controller
{
    //
    public function index()
    {
        $family = FamilyHead::with('village')
            ...
            ->where('wilayah_id',7)
            ->get();
        return view('family.yeha.index', compact('family'));
    }

   public function create()
    {
       $village = Village::all();
       return view('family.yeha.create',compact('village'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('yeha.index')->with('success','Data Kepala_Keluarga Baru Berhasil Di Tambahkan');
    }
    ...
    return view('family.yeha.edit', compact('family'));
    }
    ...
    // Simpan perubahan
    $family->save();
    return redirect()->route('yeha.index')->with('success', 'Data kepala keluarga berhasil Di Perbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        $family->delete();
        return redirect()->route('yeha.index')->with('success', 'Data kepala keluarga berhasil Di Hapus.');
