...
class FamilyHeaddukuhController extends Controller
{
    public function index()
    {
        $family = FamilyHead::with('village')
            ...
            ->where('wilayah_id',3)
            ->get();
        return view('family.dukuh.index', compact('family'));
    }

   public function create()
    {
       $village = Village::all();
       return view('family.dukuh.create',compact('village'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dukuh.index')->with('success','Data Kepala_Keluarga Baru Berhasil Di Tambahkan');
    }
    ...
    return view('family.dukuh.edit', compact('family'));
    }
    ...
    // Simpan perubahan
    $family->save();
    return redirect()->route('dukuh.index')->with('success', 'Data kepala keluarga berhasil Di Perbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        $family->delete();
        return redirect()->route('dukuh.index')->with('success', 'Data kepala keluarga berhasil Di Hapus.');
    ...
    public function show($id)
    {
        ...
        return view('family.dukuh.show',compact('family','jenis_surat'));
