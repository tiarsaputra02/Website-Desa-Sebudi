...
class FamilyHeadKelodanController extends Controller
{
    public function index()
    {
        $family = FamilyHead::with('village')
            ...
            ->where('wilayah_id',5)
            ->get();
        return view('family.kelodan.index', compact('family'));
    }

   public function create()
    {
       $village = Village::all();
       return view('family.kelodan.create',compact('village'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kelodan.index')->with('success','Data Kepala_Keluarga Baru Berhasil Di Tambahkan');
    }
    ...
    return view('family.kelodan.edit', compact('family'));
    }
    ...
    // Simpan perubahan
    $family->save();
    return redirect()->route('kelodan.index')->with('success', 'Data kepala keluarga berhasil Di Perbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        $family->delete();
        return redirect()->route('kelodan.index')->with('success', 'Data kepala keluarga berhasil Di Hapus.');
    ...
    public function show($id)
    {
        ...
        return view('family.kelodan.show',compact('family','jenis_surat'));
