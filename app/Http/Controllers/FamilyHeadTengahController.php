...
class FamilyHeadTengahController extends Controller
{
    public function index()
    {
        $family = FamilyHead::with('village')
            ...
            ->where('wilayah_id',4)
            ->get();
        return view('family.tengah.index', compact('family'));
    }

   public function create()
    {
       $village = Village::all();
       return view('family.tengah.create',compact('village'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tengah.index')->with('success','Data Kepala_Keluarga Baru Berhasil Di Tambahkan');
    }
    ...
    return view('family.tengah.edit', compact('family'));
    }
    ...
    // Simpan perubahan
    $family->save();
    return redirect()->route('tengah.index')->with('success', 'Data kepala keluarga berhasil Di Perbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        $family->delete();
        return redirect()->route('tengah.index')->with('success', 'Data kepala keluarga berhasil Di Hapus.');
    ...
    public function show($id)
    {
        ...
        return view('family.tengah.show',compact('family','jenis_surat'));
