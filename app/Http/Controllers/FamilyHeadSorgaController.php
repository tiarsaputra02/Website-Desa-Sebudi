...
class FamilyHeadSorgaController extends Controller
{
    public function index()
    {
        $family = FamilyHead::with('village')
            ...
            ->where('wilayah_id',1)
            ->get();
        return view('family.sorga.index', compact('family'));
    }

   public function create()
    {
       $village = Village::all();
       return view('family.sorga.create',compact('village'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sorga.index')->with('success','Data Kepala_Keluarga Baru Berhasil Di Tambahkan');
    }
    ...
    return view('family.sorga.edit', compact('family'));
    }
    ...
    // Simpan perubahan
    $family->save();
    return redirect()->route('sorga.index')->with('success', 'Data kepala keluarga berhasil Di Perbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        $family->delete();
        return redirect()->route('sorga.index')->with('success', 'Data kepala keluarga berhasil Di Hapus.');
    ...
    public function show($id)
    {
        ...
        return view('family.sorga.show',compact('family','jenis_surat'));
