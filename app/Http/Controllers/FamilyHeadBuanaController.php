...
class FamilyHeadBuanaController extends Controller
{
    //
    public function index()
    {
        $family = FamilyHead::with('village')
            ...
            ->where('wilayah_id',10)
            ->get();
        return view('family.buana.index', compact('family'));
    }

   public function create()
    {
       $village = Village::all();
       return view('family.buana.create',compact('village'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('buana.index')->with('success','Data Kepala_Keluarga Baru Berhasil Di Tambahkan');
    }
    ...
    return view('family.buana.edit', compact('family'));
    }
    ...
    // Simpan perubahan
    $family->save();
    return redirect()->route('buana.index')->with('success', 'Data kepala keluarga berhasil Di Perbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        $family->delete();
        return redirect()->route('buana.index')->with('success', 'Data kepala keluarga berhasil Di Hapus.');
    ...
    public function show($id)
    {
        ...
        return view('family.buana.show',compact('family','jenis_surat'));
