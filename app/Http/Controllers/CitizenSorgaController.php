...
class CitizenSorgaController extends Controller
{
    public function index($id)
    {
        $citizen = Citizen::where('wilayah_id', $id)->get();
        return view('citizen.sorga.index',compact('citizen'));
    }
    ...
    public function create($id)
    {
       ...
       $assistancetypes = AssistanceTypes::all();
        ...
        return view('citizen.sorga.create',compact('village','religion','profesion','maritalstatus','familyhead','educationlevel','assistancetypes'));
    }
    ...
    \App\Models\Citizen::create([
        ...
        return redirect()->route('sorga.show',$request->kepala_keluarga)->with('success','Data ( '. $request->nama_lengkap . ' ) Berhasil Di Tambahkan');
    }
    ...
    public function edit($id)
    {
        ...
        $maritalstatus = MaritalStatus::all();
        $assistancetypes = AssistanceTypes::all();
        return view('citizen.sorga.edit',compact('citizen','religion','profesion','educationlevel','maritalstatus','assistancetypes'));
    }
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('sorga.show',$request->kepala_keluarga)->with('success','Data ( '. $request->nama_lengkap . ' ) Berhasil Di Perbaharui');
    ...
    public function Show($id)
    {
        ...
        return view('citizen.sorga.show',compact('citizen','age','tanggal_lahir'));
    }
    ...
    public function destroy($id)
    {
        ...
        $citizen->delete();
        return redirect()->route('sorga.show',$family_id)->with('success','Data ( ' . $nama .  ' ) Berhasil Di Hapus');
