...
class DashboardController extends Controller
{
    ...
    $queryCitizen->where('wilayah_id', 2);
    $queryCitizen->where('status_hidup','Hidup');
    $totalWarga = $queryCitizen->count();
    ...
    $queryFamilyHead->where('wilayah_id', 2);
    $totalKepalaKeluarga = $queryFamilyHead->count();
    ...
    $queryJenisKelamin->where('status_hidup','Hidup');
    $queryJenisKelamin->where('wilayah_id',2);
    $laki_laki = $queryJenisKelamin->clone()->where('jenis_kelamin','Laki-Laki')->count();
    $perempuan = $queryJenisKelamin->clone()->where('jenis_kelamin','Perempuan')->count();
    $data_kelamin = [$laki_laki, $perempuan];
    $jenis_kelamin = ['Laki-Laki', 'Perempuan'];
    ...
    ->where('citizens.wilayah_id', 2)              // filter wilayah
    ->where('citizens.status_hidup', 'Hidup')      // filter hidup
    ->whereYear('citizens.created_at','<=', $tahun)     // filter tahun
    ->groupBy('profesions.pekerjaan')
    ->get();
    ...
    $tanpa_bantuan = $queryAssistance->where('wilayah_id',2)->where('status_hidup','hidup')->where('bantuan_id',null)->count();
    ...
    return view('dashboard.sebudi.index',compact(
            'totalWarga',
            'listTahun',
            'totalKepalaKeluarga',
            'data_kelamin',
    ...
    //Banjar Badeg Tengah
    public function tengah(Request $request)
    {
    if ($request->tahun === null) {
        $tahun = 2025;
    }else {
    ...
    $queryCitizen->where('wilayah_id', 4);
    $queryCitizen->where('status_hidup','Hidup');
    $totalWarga = $queryCitizen->count();
    ...
    $queryFamilyHead->where('wilayah_id', 4);
    $totalKepalaKeluarga = $queryFamilyHead->count();
    ...
    $queryJenisKelamin->where('status_hidup','Hidup');
    $queryJenisKelamin->where('wilayah_id',4);
    $laki_laki = $queryJenisKelamin->clone()->where('jenis_kelamin','Laki-Laki')->count();
    $perempuan = $queryJenisKelamin->clone()->where('jenis_kelamin','Perempuan')->count();
    $data_kelamin = [$laki_laki, $perempuan];
    $jenis_kelamin = ['Laki-Laki', 'Perempuan'];
    ...
    ->where('citizens.wilayah_id', 4)              // filter wilayah
    ->where('citizens.status_hidup', 'Hidup')      // filter hidup
    ->whereYear('citizens.created_at','<=', $tahun)     // filter tahun
    ->groupBy('profesions.pekerjaan')
    ->get();
    ...
    $tanpa_bantuan = $queryAssistance->where('wilayah_id',4)->where('status_hidup','hidup')->where('bantuan_id',null)->count();
    ...
    return view('dashboard.tengah.index',compact(
            'totalWarga',
            'listTahun',
            'totalKepalaKeluarga',
            'data_kelamin',
    ...
    $queryCitizen->where('wilayah_id', 5);
    $queryCitizen->where('status_hidup','Hidup');
    $totalWarga = $queryCitizen->count();
    ...
    $queryFamilyHead->where('wilayah_id', 5);
    $totalKepalaKeluarga = $queryFamilyHead->count();
    ...
    $queryJenisKelamin->where('status_hidup','Hidup');
    $queryJenisKelamin->where('wilayah_id',5);
    $laki_laki = $queryJenisKelamin->clone()->where('jenis_kelamin','Laki-Laki')->count();
    $perempuan = $queryJenisKelamin->clone()->where('jenis_kelamin','Perempuan')->count();
    $data_kelamin = [$laki_laki, $perempuan];
    $jenis_kelamin = ['Laki-Laki', 'Perempuan'];
    ...
    ->where('citizens.wilayah_id', 5)              // filter wilayah
    ->where('citizens.status_hidup', 'Hidup')      // filter hidup
    ->whereYear('citizens.created_at','<=', $tahun)     // filter tahun
    ->groupBy('profesions.pekerjaan')
    ->get();
    ...
    $tanpa_bantuan = $queryAssistance->where('wilayah_id',5)->where('status_hidup','hidup')->where('bantuan_id',null)->count();
    ...
    return view('dashboard.kelodan.index',compact(
            'totalWarga',
            'listTahun',
            'totalKepalaKeluarga',
            'data_kelamin',
    ...
    $queryCitizen->where('wilayah_id', 6);
    $queryCitizen->where('status_hidup','Hidup');
    $totalWarga = $queryCitizen->count();
    ...
    $queryFamilyHead->where('wilayah_id', 6);
    $totalKepalaKeluarga = $queryFamilyHead->count();
    ...
    $queryJenisKelamin->where('status_hidup','Hidup');
    $queryJenisKelamin->where('wilayah_id',6);
    $laki_laki = $queryJenisKelamin->clone()->where('jenis_kelamin','Laki-Laki')->count();
    $perempuan = $queryJenisKelamin->clone()->where('jenis_kelamin','Perempuan')->count();
    $data_kelamin = [$laki_laki, $perempuan];
    $jenis_kelamin = ['Laki-Laki', 'Perempuan'];
    ...
    ->where('citizens.wilayah_id', 6)              // filter wilayah
    ->where('citizens.status_hidup', 'Hidup')      // filter hidup
    ->whereYear('citizens.created_at','<=', $tahun)     // filter tahun
    ->groupBy('profesions.pekerjaan')
    ->get();
    ...
    $tanpa_bantuan = $queryAssistance->where('wilayah_id',6)->where('status_hidup','hidup')->where('bantuan_id',null)->count();
    ...
    return view('dashboard.ancut.index',compact(
            'totalWarga',
            'listTahun',
            'totalKepalaKeluarga',
            'data_kelamin',
    ...
    $queryCitizen->where('wilayah_id', 7);
    $queryCitizen->where('status_hidup','Hidup');
    $totalWarga = $queryCitizen->count();
    ...
    $queryFamilyHead->where('wilayah_id', 7);
    $totalKepalaKeluarga = $queryFamilyHead->count();
    ...
    $queryJenisKelamin->where('status_hidup','Hidup');
    $queryJenisKelamin->where('wilayah_id',7);
    $laki_laki = $queryJenisKelamin->clone()->where('jenis_kelamin','Laki-Laki')->count();
    $perempuan = $queryJenisKelamin->clone()->where('jenis_kelamin','Perempuan')->count();
    $data_kelamin = [$laki_laki, $perempuan];
    $jenis_kelamin = ['Laki-Laki', 'Perempuan'];
    ...
    ->where('citizens.wilayah_id', 7)              // filter wilayah
    ->where('citizens.status_hidup', 'Hidup')      // filter hidup
    ->whereYear('citizens.created_at','<=', $tahun)     // filter tahun
    ->groupBy('profesions.pekerjaan')
    ->get();
    ...
    $tanpa_bantuan = $queryAssistance->where('wilayah_id',7)->where('status_hidup','hidup')->where('bantuan_id',null)->count();
    ...
    return view('dashboard.yeha.index',compact(
            'totalWarga',
            'listTahun',
            'totalKepalaKeluarga',
            'data_kelamin',
    ...
    $queryCitizen->where('wilayah_id', 9);
    $queryCitizen->where('status_hidup','Hidup');
    $totalWarga = $queryCitizen->count();
    ...
    $queryFamilyHead->where('wilayah_id', 9);
    $totalKepalaKeluarga = $queryFamilyHead->count();
    ...
    $queryJenisKelamin->where('status_hidup','Hidup');
    $queryJenisKelamin->where('wilayah_id',9);
    $laki_laki = $queryJenisKelamin->clone()->where('jenis_kelamin','Laki-Laki')->count();
    $perempuan = $queryJenisKelamin->clone()->where('jenis_kelamin','Perempuan')->count();
    $data_kelamin = [$laki_laki, $perempuan];
    $jenis_kelamin = ['Laki-Laki', 'Perempuan'];
    ...
    ->where('citizens.wilayah_id', 9)              // filter wilayah
    ->where('citizens.status_hidup', 'Hidup')      // filter hidup
    ->whereYear('citizens.created_at','<=', $tahun)     // filter tahun
    ->groupBy('profesions.pekerjaan')
    ->get();
    ...
    $tanpa_bantuan = $queryAssistance->where('wilayah_id',9)->where('status_hidup','hidup')->where('bantuan_id',null)->count();
    ...
    return view('dashboard.lebih.index',compact(
            'totalWarga',
            'listTahun',
            'totalKepalaKeluarga',
            'data_kelamin',
    ...
    $queryCitizen->where('wilayah_id', 10);
    $queryCitizen->where('status_hidup','Hidup');
    $totalWarga = $queryCitizen->count();
    ...
    $queryFamilyHead->where('wilayah_id', 10);
    $totalKepalaKeluarga = $queryFamilyHead->count();
    ...
    $queryJenisKelamin->where('status_hidup','Hidup');
    $queryJenisKelamin->where('wilayah_id',10);
    $laki_laki = $queryJenisKelamin->clone()->where('jenis_kelamin','Laki-Laki')->count();
    $perempuan = $queryJenisKelamin->clone()->where('jenis_kelamin','Perempuan')->count();
    $data_kelamin = [$laki_laki, $perempuan];
    $jenis_kelamin = ['Laki-Laki', 'Perempuan'];
    ...
    ->where('citizens.wilayah_id', 10)              // filter wilayah
    ->where('citizens.status_hidup', 'Hidup')      // filter hidup
    ->whereYear('citizens.created_at','<=', $tahun)     // filter tahun
    ->groupBy('profesions.pekerjaan')
    ->get();
  ...
  $tanpa_bantuan = $queryAssistance->where('wilayah_id',10)->where('status_hidup','hidup')->where('bantuan_id',null)->count();
    ...
    return view('dashboard.buana.index',compact(
            'totalWarga',
            'listTahun',
            'totalKepalaKeluarga',
            'data_kelamin',
