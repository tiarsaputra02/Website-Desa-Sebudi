    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route ('ancut.update', $family->id) }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <a href="{{route('ancut.index')}}" class="btn btn-secondary">Kembali Kedaptar Kepala Keluarga</a>
