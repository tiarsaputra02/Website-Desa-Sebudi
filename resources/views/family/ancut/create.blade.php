...
<div class="page-heading">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item " aria-current="page">Banjar Dinas Ancut</li>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route ('ancut.store')}}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="mb-2" style="display:none">
                        ...
                        <input type="text" name="wilayah_id" class="form-control" value="6" required>
                        @error('wilayah_id')
                            <div class="invalid-feedback" >{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <a href="{{route('ancut.index')}}" class="btn btn-secondary">Kembali Ke Daptar Kepala Keluarga </a>
