    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route ('buana.update', $family->id) }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <a href="{{route('buana.index')}}" class="btn btn-secondary">Kembali Kedaptar Kepala Keluarga</a>
