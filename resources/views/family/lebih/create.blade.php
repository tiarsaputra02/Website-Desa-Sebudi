...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route ('lebih.store')}}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="mb-2" style="display:none">
                        ...
                        <input type="text" name="wilayah_id" class="form-control" value="9" required>
                        @error('wilayah_id')
                            <div class="invalid-feedback" >{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <a href="{{route('lebih.index')}}" class="btn btn-secondary">Kembali Ke Daptar Kepala Keluarga </a>
