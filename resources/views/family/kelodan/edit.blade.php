    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route ('kelodan.update', $family->id) }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <a href="{{route('kelodan.index')}}" class="btn btn-secondary">Kembali Kedaptar Kepala Keluarga</a>
