...
@endforeach
            ...
            <div class="pt-5">
                ...
                <div class="d-flex">
                    <a href="{{ route ('citizen.sebudi.create', $family->id) }} " class="btn btn-success mb-3 ms-auto">Tambahkan Data Agota Keluarga {{$family->kepala_keluarga}}</a>
                </div>
                    ...
                    @foreach ($family->citizen as $citizens)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route ('citizen.sebudi.edit', $citizens->id) }} " class="btn btn-warning btn-sm">Ubah</a>
                                <form action="{{ route ('citizen.sebudi.destroy', $citizens->id) }}" method="POST" style="display:inline">
                                    @csrf
                                    @method('DELETE')
...
@endif
                <a href="{{route('sebudi.index')}}" class="btn btn-secondary">Kembali Ke Daptar Kepala Keluarga</a>
            </div>
        </div>
