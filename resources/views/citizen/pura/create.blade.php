            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tambah  Warga Banjar Dinas Pura </li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card-body">
                <form action="{{ route ('citizen.pura.store')}}" method="POST">
                    ...
                    <div class="mb-2" style="display:none">
                        ...
                        <input type="hidden" name="wilayah_id" class="form-control" value="8" required>
                        @error('wilayah_id')
                            <div class="invalid-feedback" >{{$message}}</div>
                        @enderror
                    </div>
