    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Warga Banjar Dinas lebih</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item " aria-current="page">Warga Banjar Dinas Lebih</li>
                        <li class="breadcrumb-item active" aria-current="page">Detail Warga Banjar Dinas Lebih</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">
                    Detail Warga Banjar Dinas Lebih
                </h4>
            </div>
            <div class="card-body">
               ...
               <a href="{{route('citizen.lebih.citizen.lebih', $citizen->Villages->id)}}" class="btn btn-secondary">Kembali Data Warga</a>
               <a href="{{route ('lebih.show',$citizen->FamilyHead->id)}}" class="btn btn-secondary">Kembali Kedaptar Angota Keluarga {{$citizen->FamilyHead->kepala_keluarga}}</a>
