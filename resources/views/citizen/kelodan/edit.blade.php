    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('citizen.kelodan.update',$citizen->id) }}"  method="POST">
                ...
                <div class="mb-2">
                    ...
                    <a href="{{route ('kelodan.show',$citizen->kepala_keluarga)}}" class="btn btn-secondary">Kembali Kedaptar Angota Kaluarga {{$citizen->nama_lengkap}}</a>
