...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3> Warga Banjar Dinas Badeg Tengah </h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item " aria-current="page"> Warga Banjar Dinas Badeg Tengah</li>
                        <li class="breadcrumb-item active" aria-current="page">Tambah  Warga Banjar Dinas Badeg Tengah </li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route ('citizen.tengah.store')}}" method="POST">
                    ...
                    <div class="mb-2" style="display:none">
                        ...
                        <input type="hidden" name="wilayah_id" class="form-control" value="4" required>
                        @error('wilayah_id')
                            <div class="invalid-feedback" >{{$message}}</div>
                        @enderror
                    </div>
                    ...
                    <a href="{{route ('tengah.show', $familyhead->id)}}" class="btn btn-secondary">Kembali Ke Kartu Keluraga {{$familyhead->kepala_keluarga}}</a>
