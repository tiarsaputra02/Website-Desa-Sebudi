            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Detail Warga Banjar Dinas Ancut</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">
                    Detail Warga Banjar Dinas Ancut
                </h4>
            </div>
            <div class="card-body">
               ...
               <a href="{{route('citizen.ancut.citizen.ancut', $citizen->Villages->id)}}" class="btn btn-secondary">Kembali Data Warga</a>
               <a href="{{route ('ancut.show',$citizen->FamilyHead->id)}}" class="btn btn-secondary">Kembali Kedaptar Angota Keluarga {{$citizen->FamilyHead->kepala_keluarga}}</a>
