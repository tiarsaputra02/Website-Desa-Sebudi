    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Data Warga Banjar Dinas Badeg Dukuh</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item " aria-current="page">Data Warga Banjar Dinas Badeg Dukuh</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    Data Warga Banjar Dinas Badeg Dukuh
                </h5>
            </div>
            <div class="card-body">
                ...
                <table class="table table-striped" id="table1">
                    <thead>
                        <tr>
                            <th>Nama Warga Banjar Badeg Dukuh</th>
                            <th>No Nik</th>
                            <th>Action</th>
                        </tr>
                    </thead>
