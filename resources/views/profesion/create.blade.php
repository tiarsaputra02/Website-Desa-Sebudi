            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tambah Pekerjaan </li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route ('profesion.store')}}" method="POST">
                    ...
                    <button type="submit"class="btn btn-primary">Tambah Pekerjaan Baru</button>
                    <a href="{{route('profesion.index')}}" class="btn btn-secondary">Kembali Ke Daptar Pekerjaan </a>
