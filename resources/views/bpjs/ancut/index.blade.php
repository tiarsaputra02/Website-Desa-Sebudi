                ...
                <table class="table table-striped" id="table1">
                    ...
                    @foreach ($bpjs_member as $bpjs_members)
                        <tr>
                            ...
                            <a href="{{ route ('bpjs.ancut.edit', $bpjs_members->id) }} " class="btn btn-warning btn-sm">Ubah</a>

                            <form action="{{ route('bpjs.ancut.destroy', $bpjs_members->id) }}" method="POST" style="display:inline">
                                @csrf
                                @method('DELETE')
