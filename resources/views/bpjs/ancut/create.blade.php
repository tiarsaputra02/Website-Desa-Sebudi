    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3> Bpjs Banjar Dinas Ancut</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item " aria-current="page"> Bpjs Banjar Dinas Ancut</li>
                        <li class="breadcrumb-item active" aria-current="page">Tambah Bpjs Banjar Dinas Ancut </li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    Tambah Data BPJS Warga Dinas Ancut
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route ('bpjs.ancut.store')}}" method="POST">
                    ...
                    <button type="submit"class="btn btn-primary">Tambah Data
                        BPJS</button>
                    <a href="{{route('bpjs.ancut.index')}}" class="btn
