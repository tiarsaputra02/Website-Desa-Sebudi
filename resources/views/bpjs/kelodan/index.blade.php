    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>BPJS Masyarakat Banjar Badeg Kelodan</h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item " aria-current="page">BPJS Masyarakat Banjar Badeg Kelodan</li>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">
                    BPJS Masyarakat Banjar Badeg Kelodan
                </h5>
            </div>
            <div class="card-body">
                ...
                <table class="table table-striped" id="table1">
                    ...
                    @foreach ($bpjs_member as $bpjs_members)
                        <tr>
                            ...
                            <a href="{{ route ('bpjs.kelodan.edit', $bpjs_members->id) }} " class="btn btn-warning btn-sm">Ubah</a>

                            <form action="{{ route('bpjs.kelodan.destroy', $bpjs_members->id) }}" method="POST" style="display:inline">
                                @csrf
                                @method('DELETE')
