                ...
                <table class="table table-striped" id="table1">
                    ...
                    @foreach ($bpjs_member as $bpjs_members)
                        <tr>
                            ...
                            <a href="{{ route ('bpjs.lebih.edit', $bpjs_members->id) }} " class="btn btn-warning btn-sm">Ubah</a>

                            <form action="{{ route('bpjs.lebih.destroy', $bpjs_members->id) }}" method="POST" style="display:inline">
                                @csrf
                                @method('DELETE')
